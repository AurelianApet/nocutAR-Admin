...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        selTopMenu(2);
        $("#campain_menu1").html('<b>VI</b>');
        $("#threeModel_menu1").html('3D Model');
        //        $("#adv_menu1").html('Advertisement');
//        $("#gmap_menu1").html('GoogleMap');
...
//        $("#gmap_menu").attr('style', 'border-top-width:1; border-right-width:1; border-bottom-width:2; border-left-width:1; border-top-color:black; border-right-color:black; border-bottom-color:rgb(235,235,235); border-left-color:black; border-top-style:none; border-right-style:none; border-bottom-style:solid; border-left-style:none;');
//        $("#adv_menu").attr('style', 'border-top-width:1; border-right-width:1; border-bottom-width:2; border-left-width:1; border-top-color:black; border-right-color:black; border-bottom-color:rgb(235,235,235); border-left-color:black; border-top-style:none; border-right-style:none; border-bottom-style:solid; border-left-style:none;');
        $("#threeModel_menu").attr('style', 'border-top-width:1; border-right-width:1; border-bottom-width:2; border-left-width:1; border-top-color:black; border-right-color:black; border-bottom-color:rgb(235,235,235); border-left-color:black; border-top-style:none; border-right-style:none; border-bottom-style:solid; border-left-style:none;');
    ...
    function onShowDetail(marker_url, title, regdate, changedate, api_requests) {
        $("#spTitle").html(title);
        $("#spRegdate").html("Create datetime: " + regdate.substr(0, 10) + "<br>Modify datetime: " + changedate.substr(0, 10));
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSearch" runat="server">
    <table style="width:100%;height:100%">
          <tr>
            <td>
                <div style="background-image: url(IMG/_0015_search_box.png);width:90%;height:54%;display:none;">
                ...
                <table cellpadding="0" cellspacing="0" align="center" width="1022" align="center">
                    ...
                    <tr>
                        ...
                        <td width="200" height="69" style="cursor:pointer" onclick="onAddCampain()">
                            <p align="right">
                                <span style="font-size:11pt;"><font face="돋움" color="#ACACAC"><b> + Add VI</b></font></span>
                            </p>
                        </td>
                    </tr>
                    </tbody>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="276">
                                            <tr>
                                                <td width="276" height="29">
                                                    <font face="돋움" color="white"><b><span style="font-size:12pt;" id="spTitle">VI Name</span></b></font>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="265">
                                                        <tr>
                                                            <td width="265" height="43">
                                                                <font face="돋움" color="white"><span style="font-size:10pt;" id="spRegdate">Create datetime: <br>Modify datetime:</span></font>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                ...
                                                <tr>
                                                    <td width="37" height="33"><img src="img/icon_view2.png" width="31" height="22" border="0"></td>
                                                        ...
                                                        <td width="52" height="33" align="right">
                                                            <b><font face="돋움" color="white"><span style="font-size:11pt; cursor:pointer;" onclick="closePopup()">Close</span></font></b>
                                                        </td>
                                                </tr>
                                            </table>
                                        </div>
        ...
        <tbody><tr>
                ...
                <tr>
                    <td width="514" height="114">
                        <p align="center" style="margin-bottom:3px;margin-top:3px;"><b><span style="font-size:11pt;"><font face="돋움" color="#666666">Register VI</font></span></b></p>
                            ...
                            <tbody><tr>
                                <td width="493" height="41" align="center">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvProjectName" runat="server" ValidationGroup="vGroup01" CssClass="error-message"
                                        ControlToValidate="txtTitle" Font-Size="10pt" ErrorMessage="Input VI name" Display="Dynamic"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </tbody></table>
                    </td>
                        ...
                        <table cellpadding="0" cellspacing="0" width="410" align="center">
                            <tbody><tr>
                                <td width="410" height="114">
                                    ...
                                    <p align="center"><b><span style="font-size:11pt;"><font face="돋움" color="#666666">Delete VI</font></span></b></p>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" align="center" width="387">
                        <tr>
                            <td width="387" height="77" valign="middle" align="center">
                                ...
                                <font face="돋움" color="#666666"><span style="font-size:12pt;"><b>Will you copy VI?</b></span></font>
                            </td>
                        </tr>
                    </table>
                                ...
                                <table cellpadding="0" cellspacing="0" width="234">
                                    <tr>
                                        <td width="113" height="48">
                                            <input type="button" class="clsBigButton" onclick="closePopup()" value="Close" style=" width:107px; height:33px; background-color:#7F7F7F;" />
                                        </td>
                                        <td width="121" height="48">
                                            <asp:Button runat="server" ID="btnCopyCampain" width="107" height="33" Text="OK" 
