                    ...
                    <td width="652" height="47">
                        <table cellpadding="0" cellspacing="0" width="630">
                            <tr>
                                ...
                                <td width="198" height="37"><b><font face="돋움" color="#666666"><span style="font-size:12pt;">Registered VI</span></font></b></td>
    ...
    <tr>
        <td width="1089" height="1187" align="center" valign="top" style="border-width:1px; border-top-color:rgb(229,233,235); border-right-color:black; border-bottom-color:black; border-left-color:black; border-top-style:solid; border-right-style:none; border-bottom-style:none; border-left-style:none;">
                ...
                <tr>
                    <td width="1041" height="40">
                        <table cellpadding="0" cellspacing="0" align="center" width="1016">
                            <tr>
                                <td width="453" height="35"><span style="font-size:11pt;"><b><font face="돋움" color="#727272">&nbsp;Regisetred Marker</font></b></span></td>
            ...
            <table cellpadding="0" cellspacing="0" width="1020" style="border-collapse:collapse;" align="center">
                <tr>
                    <td class="clsMarkerHeader">1</td>
                    <td class="clsMarkerHeader">2</td>
                    <td class="clsMarkerHeader">3</td>
                    <td class="clsMarkerHeader">4</td>
                    <td class="clsMarkerHeader">5</td>
                    <td class="clsMarkerHeader">6</td>
                    <td class="clsMarkerHeader">7</td>
                    <td class="clsMarkerHeader">8</td>
                    <td class="clsMarkerHeader">9</td>
                    <td class="clsMarkerHeader">10</td>
                    <td class="clsMarkerHeader">11</td>
                    <td class="clsMarkerHeader">12</td>
                </tr>
                <tr>
            ...
            <asp:GridView ID="gvContent" runat="server" CellPadding="0" CellSpacing="0"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Marker">
                        <ItemTemplate>
                            <input type="button" class="clsBigButton" value="Preview" onclick='onShowMarker("<%#Eval("marker_url") %>")' style="width:76px; height:22px"/>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" Width="139px" Wrap="false" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Registered <br/>Object">
                        <ItemTemplate>
    ...
    <tr>
        <td width="100%" height="40" style="border-width:1px; border-color:rgb(216,216,216); border-style:solid;" bgcolor="#D8D8D8">
            <table cellpadding="0" cellspacing="0" align="center" width="485">
                <tr>
                    <td width="50%" height="36"><b><font face="돋움" color="#4C4C4C"><span style="font-size:11pt;">Confirm marker</span></font></b></td>
