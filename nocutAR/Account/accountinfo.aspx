            ...
            <table cellpadding="0" cellspacing="0" width="928">
                ...
                <tr>
                    ...
                    <td width="135" height="50">
                        <b><span style="font-size:11pt;"><font face="돋움" color="#666666">Company Name</font></span></b>
                    </td>
                ...
                <tr>
                    <td width="56" height="50">&nbsp;</td>
                    <td width="135" height="50">
                        <b><span style="font-size:11pt;"><font face="돋움" color="#666666">UserID</font></span></b>
                    </td>
                    <td width="737" height="50" class="clsLabel">
                ...
                <tr>
                    <td width="56" height="50">&nbsp;</td>
                    <td width="135" height="50">
                        <b><span style="font-size:11pt;"><font face="돋움" color="#666666">Password</font></span></b>
                    </td>
                ...
                <tr>
                    ...
                    <td width="135" height="40">
                        <b><span style="font-size:11pt;"><font face="돋움" color="#666666">Useful Product</font></span></b>
                    </td>
                ...
                <tr>
                    <td width="56" height="40">&nbsp;</td>
                    <td width="135" height="40">
                        <b><span style="font-size:11pt;"><font face="돋움" color="#666666">Period of time</font></span></b>
                    </td>
                    <td width="737" height="40" class="clsLabel">
                ...
                <table cellpadding="0" cellspacing="0" width="499" align="center">
                    <tr>
                        <td width="499" height="57">
                            <b><font face="돋움" color="#4C4C4C"><span style="font-size:12pt;">&nbsp;&nbsp;Change Password</span></font></b>
                        </td>
                    </tr>
                    <tr>
                        <td width="499" height="156">
                            <table cellpadding="0" cellspacing="0" width="473" align="center">
                                <tr>
                                    <td width="125" height="40"><span style="font-size:11pt;"><font face="돋움" color="#666666">Current Password*</font></span></td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="473" align="center">
                                <tr>
                                    <td width="125" height="40"><span style="font-size:11pt;"><font face="돋움" color="#666666">New Password*</font></span></td>
                                    <td width="348" height="40">
                            ...
                            <table cellpadding="0" cellspacing="0" width="473" align="center">
                                <tr>
                                    <td width="125" height="40"><span style="font-size:11pt;"><font face="돋움" color="#666666">Confirm New Password*</font></span></td>
                                    <td width="348" height="40">
                            ...
                            <table cellpadding="0" cellspacing="0" width="251">
                                <tr>
                                    <td width="123" height="48" align="left">
                                        <input type="button" class="clsBigButton" onclick="closePopup()" value="Cancel" style="background-color:#7F7F7F; width:112px; height:33px">
                                    </td>
                                    <td width="128" height="48" align="left">
                                        <asp:Button runat="server" ID="btnChangePwd" CssClass="clsBigButton" 
                                            Width="107px" Height="33px" Text="Register" onclick="btnChangePwd_Click" OnClientClick="return checkPwd();" />
                                    </td>
                                </tr>
                            </table>
                        </td>
