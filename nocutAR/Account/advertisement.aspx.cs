        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            string strimgurl1 = "<input type = 'text' value = '"
                + imageurl1
                + "' style = 'font-size:13pt;height:28px;width:280px;border-width:1px;border-color:rgb(204,204,204);border-style:solid;background-color:white' id = 'adv_file_text1' size = '30' placeholder = '   jpg,jpeg,png file' readonly= 'readonly' />";
...
*/
            ...
            string strimgurl2 = "<input type='text' value = '"
                + imageurl2
                + "' style='font-size:13pt;height:30px;width:450px;border-width:1px;border-color:rgb(204,204,204);border-style:solid;background-color:white' id='adv_file_text2' size='30' placeholder='   jpg,jpeg,png file' readonly='readonly' />";
