    ...
    public partial class CampainList : Common.PageBase
    {
        ...
        protected override void BindData()
        {
            ...
            string strItem = "<td width='280' height='307' ><div style='position:relative;text-align:center;'> "
                ...
                + "                                     <font face='돋움'>"
                + "                                         Modify datetime:{2}<br>"
                + "                                         Last Modify datetime:{3}<br>"
                + "                                     </font>"
                + "                                 </span>"
                + "                             </p>"
                + "                         </td>"
            ...
            string footerpage = "<table width='1240' style='bottom:0px;' bgcolor='#595959'><tbody><tr><td width='1240' height='40' bgcolor='#595959'><p align='right'  style='margin-top:0px; margin-bottom:0px; '>"
                      + "<b><font face='돋움' color='#FFE4F2' style='padding-right: 10px;'><span style='font-size:10pt;'></span></font><span style='font-size:10pt;'><font face='돋움' color='#CCCCC'></font></span></b>"
        ...
        protected void btnRegCampain_Click(object sender, EventArgs e)
        {
            ...
            if (title.Length == 0)
            {
                ShowMessageBox("Input campaign name");
                return;
            }
        ...
        protected void btnDelCampain_Click1(object sender, EventArgs e)
        {
            ...
            {
                ShowMessageBox("Unpermitted Access", "ProjectList.aspx");
                return;
            }
            ...
            {
                ShowMessageBox("Cannot delete marker while registering marker. Please try again later.", "CampainList.aspx");
                return;
            }
            ...
            RunVUpload("COAR remove " + "test_" + content_id);
            Response.Redirect("CampainList.aspx");
        }
    }
}