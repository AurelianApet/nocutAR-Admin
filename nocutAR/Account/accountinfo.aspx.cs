...
namespace nocutAR.Account
{
    public partial class accountinfo : Common.PageBase
    {
        ...
        protected void btnChangePwd_Click(object sender, EventArgs e)
        {
            ...
            {
                ShowMessageBox("Not matching current password.");
                return;
            }
            if (newPwd != confirmPwd)
            {
                ShowMessageBox("Not matching new password.");
                return;
            }
            try
            {
                ...
                ShowMessageBox("Successful changed password.");
            }
            catch
            {
                ShowMessageBox("Error while changing password.");
                return;
            }
        }
    }
