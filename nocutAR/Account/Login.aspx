...
<body>
    <form id="form1" runat="server">      
        ...
        <td width="100%">
            ...
            <table cellpadding="0" cellspacing="0" width="400" align="center" bgcolor="#83A0F3" height="400" background="IMG/_0010_login.png">
                <tr>
                ...
                <tr height="20">
                    <td width="200" height="40" align="center">
                        ...
                        <asp:Label ID="Label3" runat="server" AssociatedControlID="chkAutoLogin" CssClass="inline" Font-Size="11pt" Font-Names="SpoqaHanSans" ForeColor="#FFFFFF">AutoLogin</asp:Label>                        
                    </td>
                    <td width="200" height="40" align="center">
                        <asp:CheckBox ID="chkRememberMe" runat="server" />
                        <asp:Label ID="Label2" runat="server" AssociatedControlID="chkRememberMe" CssClass="inline" Font-Size="11pt" Font-Names="SpoqaHanSans" ForeColor="#FFFFFF">SaveID</asp:Label>
                    </td>
                </tr>
            </table>
        </td>
