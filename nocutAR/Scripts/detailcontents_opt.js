...
$(document).ready(function () {
    ...
    $("#notepad_content").on('keyup', function () {
        ...
        if ($(this).val().length >= 60) {
            alert("Cannot input more than 60 letters");
        }
    ...
    /*세부옵션의 기본형과 제작형 절환시 File UploadButton의 활성 비활성화*/
    /*$('.rdbWeb1').click(
    function (event) {
    ...
    //alert("Fileinput 비활성화");
    $("#telbtn_path").attr("disabled", "disabled");
    $("#btnTelbtnBrowse").attr("disabled", "disabled");
    $("#telbtn_path_text").attr("disabled", "disabled");
    }
    else if (this.value == 'custom') {
    //alert("File input 활성화");
    $("#telbtn_path").removeAttr("disabled");
    $("#btnTelbtnBrowse").removeAttr("disabled");
    $("#telbtn_path_text").removeAttr("disabled");
    }
    ...
    $('#image_file').bind("change", function () {
        ...
        /*용량제한*/
        if (size > 3) {
            alert("Can upload less than 3MB file size");
            return;
        }
        /***용량제한***/
        isFileChange = 1;
    ...
    $('#slide_file').bind("change", function () {
        ...
        if (file) {
            ...
            if ((file.size / 1053317.6) > 3) {
                alert("Can upload less than 3MB size");
                return;
            }
            /***용량제한***/
            ShowProgress2();
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress2();
                    $("#slide_file").val('');
                    alert("An error occurs  while registering slide");
                }
            });
        }
    });
    ...
    $('#capture_file').bind("change", function () {
        ...
        if (file) {
            ...
            /*용량제한*/
            if ((file.size / 1053317.6) > 3) {
                alert("Can upload file size less than 3MB");
                return;
            }
            /***용량제한***/
            ShowProgress2();
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress2();
                    $("#capture_file").val('');
                    alert("An error occurs  while registering image");
                }
            });
        }
    });
    ...
    $("#capturebtn_path").bind("change", function () {
        ...
        /*용량제한*/
        if (btnsize > 3) {
            alert("Can upload file less than 3MB size");
            return;
        }
        /***용량제한***/
    ...
    $("#video_file1").bind("change", function () {
        ...
        /*용량제한*/
        if (size > 50) {
            alert("Can upload file size less than 50MB");
            return;
        }
        /***용량제한***/
        isFileChange = 1;
    ...
    $("#chromakey_file").bind("change", function () {
        ...
        /*용량제한*/
        if (size > 80) {
            alert("Can upload file size less than 80MB");
            return;
        }
        /***용량제한***/
        isFileChange = 1;
...
function OnVideoApply1() {
    ...
    if (run_opt == 3)
    {
        ...
        if (file.files[0] != null) {
            if ((file.files[0].size / 1053317.6) > 5) {
                alert("Cannot register image more than 5MB size");
                return false;
            }
            //create new FormData instance to transfer as Form Type
            var data = new FormData();
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress();
                    alert("An error occurs  while registering advertisement image");
                }
            });
            //                }, 500);
        }
    ...
    if (isFileChange) {
        ...
        $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                HideProgress();
                alert("An error occurs  while registering video");
            }
        });
        isFileChange = 0;
    }
    ...
    /*웹Button이 제작형인 경우 처리부분*/
        ...
        if (isFileChange) {
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress();
                    alert("An error occurs  while registering web button");
                }
            });
            //File컨트롤 초기화
            ...
            if (webList[index] != null) {
                if (webList[index].backurl == "none") {
                    alert("Please register button image");
                    return;
                }
                pos = $(objName).position();
                var element = '<div id="temp" style="min-width:98px; width: 100px; height:auto; position:absolute">';
...
function OnSlideApply1() {
    ...
    if (prevArray.length == 0) {
        alert("Please register more than one image");
        return;
    }
...
function onChangeCaptureType(type) {
    ...
    $("#spCapture").html(type == 0 ? "Chroma-key photo" : "phototakenwith");    
    ...
    if (captureList[index] == null) {
        ...
        /*캡쳐Button이 제작형일때*/
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress();
                    alert("An error occurs  while registering capture button");
                }
            });
        ...
        /*캡쳐Button이 제작형일때*/
            ...
            if (!isFileChange) {
                if (captureList[index].backurl == "none") {
                    alert("Please select button image");
                    return;
                }
...
function OnThreeApply() {
    if ($("#front_angle").val() == "Object direction" || $("#run_times").val() == "running time") {
        alert("Please input object direction, running time");
        return;
    }
    var index = objName.substr(7);
    ...
    if (front_angle > 360 || front_angle < 1) {
        alert("Please input right direction of object");
        return;
    }
    ...
    if (isFileChange == 2) {
        ...
        $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                HideProgress();
                alert("An error occurs  while registering 3D animation");
            }
        });
        ...
        if (threeList[index] != null) {
            if (threeList[index].url1 == "none" || threeList[index].url2 == "none") {
                alert("Please register 3D animation");
                return;
            }
            var pos = $(objName).position();
            ...
            alert("You must input unity3d zip file");
            return;
        }
    }
}
...
function OnTelApply1() {
    if ($("#tel_no").val() == "" || $("#tel_no").val() == "Phonenumber '-' abstruction") {
        alert("Please input postphone number.");
        return;
    }
    var index = objName.substr(5);
        ...
        if (isFileChange) {
            ...
            if (telList[index] != null) {
                if (telList[index].backurl == "none") {
                    alert("Please input register button image");
                    return;
                }
                pos = $(objName).position();
                var element = '<div id="temp" style="min-width:98px; width: 100px; height:auto; position:absolute">';
...
function OnGoogleMapApply() {
    if ($("#coordinate").val() == "" || $("#coordinate").val() == "position:Lat,Lng") {
        alert("Please input position point");
        return;
    }
    ...
    /***구글맵Button이 기본형인 경우 처리부분***/

    /*구글맵Button이 제작형인 경우 처리부분*/
        ...
        if (isFileChange) {
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress();
                    alert("An error occurs  while registering google map button");
                }
            });
            //File컨트롤 초기화
...
function OnNotepadApply1() {
    if ($("#notepad_content").val() == "" || $("#notepad_content").val() == "content") {
        alert("Input content");
        return;
    }
    var index = objName.substr(9);
...
function onChangeBGMType(type) {
    ...
    $("#spNorBGMLabel").html(type == 1 ? "BGM" : "sound");
    if (type == 1 || type == 2) {
...
function OnAudioApply1() {
    ...
    if (audioList[index] == null) {
        if (!isFileChange) {
            alert("Please register sound file");
            return;
        }
        var file = document.getElementById("audio_file");
        var size = file.files[0].size / 1053317.6;
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if (btnkind == 2) {
                    ...
                    $.ajax({
                        ...
                        error: function (jqXHR, textStatus, errorThrown) {
                            HideProgress();
                            alert("An error occurs  while registering audio button");
                        }
                    });
                    //File컨트롤 초기화
                ...
                if (btnkind != 2) {
                    ...
                    if (btnkind == 1) {
                        if (mode_index == 1 || mode_index == 2) {
                            ...
                            $(".tempcontent" + " span").css("color", textcolor);
                            $(".tempcontent" + " span").html((mode_index == 1 || btnkind == 0) ? "BGM" : "sound");
                            $(".tempcontent > table").css("background-color", color);
                            $(".tempclass").removeClass("tempclass");
                            $(".tempcontent").removeClass("tempcontent");
                        }
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                HideProgress();
                alert("An error occurs  while registering sound");
            }
        });
...
function OnChromakeyApply() {
    ...
    if (chromakeyList[index] == null) {
        if (!isFileChange) {
            alert("Please register chromakey video file");
            return;
        }
        var file = document.getElementById("chromakey_file");
        var size = file.files[0].size / 1053317.6;
        ...
        $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                HideProgress();
                alert("An error occurs  while registering chromakey");
            }
        });
