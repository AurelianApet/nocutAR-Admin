...
function OnSave() {
    ...
    if (title == "") {
        alert("Please register VI name.");
        return false;
    }
    if ($("#markImg").attr("src") == "") {
        if ($("#viewGP").val == "")
        {
            alert("Please register marker image.");
...
//    var GMP = $("#viewGP").val;
    var GMP = document.getElementById("viewGP").value;
    ...
    */
    ...
    $.ajax({
        ...
        success: function (data) {
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            $.ajax({
                                ...
                                error: function (XMLHttpRequest, textStatus, errorThrown) {
                                    alert("An error occurs while registering marker image.");
                                }
                            });
            ...
            if (select_type_content != null && select_type_content != "")
            {
//                var content = select_type_content.split(',');
//                for(var i = 0; i < content.length - 1; i ++)
//                {
                    arrResult.push({
                        obj: "select_type_content",
                        select_type_content:select_type_content
                    });
//                }
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    alert("Successful changed VI.");
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    alert("An error occurs while saving VI.");
                }
            });
        },
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            alert("An error occurs while reading marker information.");
        }
    });
    HideProgress();
}