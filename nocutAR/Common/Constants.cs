...
namespace nocutAR.Common
{
    public class Constants
    {
        ...
        public const string SITE_SELECTALL = "All";    // 검색시 전체Selection값

        public const string EVENT_LOGIN = "Login";
        public const string EVENT_LOGOUT = "Logout";
        public const string EVENT_ADDUSER = "AddAccount";
        public const string EVENT_DELUSER = "DelAccount";
        public const string EVENT_MODUSER = "ModifyAccount";
        public const string EVENT_ADDPRODUCT = "RegisterProduction";
        public const string EVENT_DELPRODUCT = "DeleteProduction";
        public const string EVENT_MODPRODUCT = "ModifyProduction";
        public const string EVENT_ADDNOTICE = "RegisterNotice";
        public const string EVENT_DELNOTICE = "DelNotice";
        public const string EVENT_MODNOTICE = "ModifyNotice";
        public const string EVENT_CHANGEPWD = "Change Manager PWD";

        public const string EVENT_ADDPROJECT = "Create VI Group";
        public const string EVENT_DELPROJECT = "Del VI Group";
        public const string EVENT_ADDCAMPAIGN = "Create VI";
        public const string EVENT_DELCAMPAIGN = "Delete VI";
        public const string EVENT_MODCAMPAIGN = "Modify VI";
