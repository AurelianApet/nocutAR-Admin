<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Account/UserPage.Master" CodeBehind="GoogleMap.aspx.cs" Inherits="nocutAR.Account.GoogleMap" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="/Scripts/detailcontents_opt1.js" type="text/javascript"></script>
    <script src="/Scripts/init_obj1.js" type="text/javascript"></script>
    <script src="/Scripts/edit_obj1.js" type="text/javascript"></script>
    <script src="/Scripts/toolbar1.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#gmap_menu").attr('style', 'border-top-width:1; border-right-width:1; border-bottom-width:2; border-left-width:1; border-top-color:black; border-right-color:black; border-bottom-color:rgb(93,129,236); border-left-color:black; border-top-style:none; border-right-style:none; border-bottom-style:solid; border-left-style:none;');
        });
                                ...
                                <table cellpadding="0" cellspacing="0" width="1200">
                                    <tr>
                                        <td width="250" height="70" style="border-top-width:1;border-right-width:1;border-bottom-width:2;border-left-width:1;border-top-color:black;border-right-color:black;border-top-style:none;border-right-style:none;border-bottom-style:solid;border-left-style:none;">
                                            <p align="center"><font face="돋움" color="#555555"><span style="font-size:12pt;"><b>Edit GoogleMap</b></span></font></p>
                                        </td>
        ...
        <table cellpadding="0" cellspacing="0" align="center" width="1240" style="border-collapse: collapse;">
            <tr>
                ...
                <td width="960" valign="top">
                    ...
                    <script type="text/javascript" async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDmd-eb-yFdxMmJFm165liceg2qTnLwjDg&callback=initMap"></script>
                </td>
            </tr>
    </table>
