...
function onSelItem(id) {
    ...
    switch (id) {
        ...
        case 8:
            ...
            $(".tempclass" + " span").html("ImageSlide");
    ...
    $(".edit-btn").click(objectid, function (event) {
        ...
        if (objectid.indexOf("video_") == 0) {
            ...
            if (captureList[index] == null) {
                ...
                var type = captureList[index].type; //기본Button, 커스텀Button
            ...
            if (notepadList[index] != null) {
                ...
                $("#notepad_content").val("");
                $("#spNotepadPreview").html("Please input text.");
            ...
            if (audioList[index] == null) {
                ...
                var btnkind = audioList[index].btnkind;   // 표시안함, 기본Button, 커스텀Button
                var btntype = audioList[index].btntype;   // BGM, SOUND
                var color = audioList[index].color;       // 기본Button Color
                ...
                $("#spNorBGMLabel").html(mode_index == 1 ? "BGM" : "sound");
...
function showPanel(objectid) {
    ...
    $.ajax({
        ...
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            alert("An Error occur while reading 3D template information.");
        }
    });
}
