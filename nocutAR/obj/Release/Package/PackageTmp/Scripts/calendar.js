...
function doClick() {															// 날자를 Selection하였을 경우
...
function Show_cal(sYear, sMonth, sDay) {
	...
	Cal_HTML = "<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 ONMOUSEOVER=doOver(); ONMOUSEOUT=doOut(); STYLE='font-size:8pt;font-family:Tahoma;'>"
			+ "<TR ALIGN=CENTER><TD COLSPAN=7 nowrap=nowrap ALIGN=CENTER><SPAN TITLE='PrevMonth' STYLE=cursor:hand; onClick='Show_cal("+intPrevYear+","+intPrevMonth+",1);'><FONT COLOR=Navy>◀</FONT></SPAN> "
			+ "<B STYLE=color:BLACK>"+get_Yearinfo(intThisYear,intThisMonth,intThisDay)+"Year&nbsp;"+get_Monthinfo(intThisYear,intThisMonth,intThisDay)+"Month</B>"
			+ " <SPAN TITLE='NextMonth' STYLE=cursor:hand; onClick='Show_cal("+intNextYear+","+intNextMonth+",1);'><FONT COLOR=Navy>▶</FONT></SPAN></TD></TR>"
			+ "<TR HEIGHT=23px ALIGN=CENTER BGCOLOR='#7CB7F6' STYLE='color:Black;font-weight:bold;'><TD>Sun</TD><TD>Mon</TD><TD>Tue</TD><TD>Wed</TD><TD>Thu</TD><TD>Fri</TD><TD>Sat</TD></TR>";
